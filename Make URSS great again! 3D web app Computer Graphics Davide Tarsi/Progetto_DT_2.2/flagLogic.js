...
/*function checkFlag(){
    if (tankPosition[0] > flagPosition[0] - 10 && tankPosition[0] < flagPosition[0] + 10 && tankPosition[2] > flagPosition[2] - 10 && tankPosition[2] < flagPosition[2] + 10){
        console.log("Hai catturato la bandiera!");
        flagCaptured = true;
        flagPosition = [0,0,0];
    }
